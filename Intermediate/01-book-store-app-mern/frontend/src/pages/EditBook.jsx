      ...
      <div className="flex flex-col border-2 border-sky-400 rounded-xl w-[600px] p-4 mx-auto bg-white shadow-lg">
        <div className="my-4">
          ...
          <input
            ...
            className="border-2 border-gray-300 px-4 py-2 w-full focus:outline-none focus:border-sky-500"
          />
        </div>
        <div className="my-4">
        ...
        <button
          className="py-2 px-4 bg-sky-500 text-white rounded-full hover:bg-sky-600 transition duration-300"
